...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	weComHandler := handler.NewWeComHandler(configConfig, redeemService, groupService)
	...
	zhipuGatewayService := service.NewZhipuGatewayService(configConfig, accountRepository, usageLogRepository, userRepository, userSubscriptionRepository, gatewayCache, concurrencyService, schedulerSnapshotService, billingService, billingCacheService, deferredService)
	zhipuGatewayHandler := handler.NewZhipuGatewayHandler(zhipuGatewayService, billingCacheService, apiKeyService, usageRecordWorkerPool, gatewayService, errorPassthroughService, configConfig)
	kimiGatewayService := service.NewKimiGatewayService(configConfig, accountRepository, usageLogRepository, userRepository, userSubscriptionRepository, gatewayCache, concurrencyService, schedulerSnapshotService, billingService, billingCacheService, deferredService)
	kimiGatewayHandler := handler.NewKimiGatewayHandler(kimiGatewayService, billingCacheService, apiKeyService, usageRecordWorkerPool, gatewayService, errorPassthroughService, configConfig)
	miniMaxGatewayService := service.NewMiniMaxGatewayService(configConfig, accountRepository, usageLogRepository, userRepository, userSubscriptionRepository, gatewayCache, concurrencyService, schedulerSnapshotService, billingService, billingCacheService, deferredService)
	miniMaxGatewayHandler := handler.NewMiniMaxGatewayHandler(miniMaxGatewayService, billingCacheService, apiKeyService, usageRecordWorkerPool, gatewayService, errorPassthroughService, configConfig)
	...
	handlers := handler.ProvideHandlers(authHandler, weComHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, soraGatewayHandler, zhipuGatewayHandler, kimiGatewayHandler, miniMaxGatewayHandler, soraClientHandler, handlerSettingHandler, totpHandler, idempotencyCoordinator, idempotencyCleanupService)
