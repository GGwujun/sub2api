...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "token_quota_used", Type: field.TypeInt64, Default: 0},
		{Name: "token_quota_daily", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_daily_used", Type: field.TypeInt64, Nullable: true, Default: 0},
		{Name: "token_quota_daily_start", Type: field.TypeTime, Nullable: true},
		{Name: "token_quota_weekly", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_weekly_used", Type: field.TypeInt64, Nullable: true, Default: 0},
		{Name: "token_quota_weekly_start", Type: field.TypeTime, Nullable: true},
		{Name: "token_quota_monthly", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_monthly_used", Type: field.TypeInt64, Nullable: true, Default: 0},
		{Name: "token_quota_monthly_start", Type: field.TypeTime, Nullable: true},
	...
	APIKeysTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "apikey_token_quota_token_quota_used",
				Unique:  false,
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "token_quota", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_daily", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_weekly", Type: field.TypeInt64, Nullable: true},
		{Name: "token_quota_monthly", Type: field.TypeInt64, Nullable: true},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "token_usage_total", Type: field.TypeInt64, Default: 0},
		{Name: "token_quota_accumulated", Type: field.TypeInt64, Default: 0},
		{Name: "token_usage_daily", Type: field.TypeInt64, Default: 0},
		{Name: "token_usage_weekly", Type: field.TypeInt64, Default: 0},
		{Name: "token_usage_monthly", Type: field.TypeInt64, Default: 0},
		{Name: "token_daily_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "token_weekly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "token_monthly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[24], UserSubscriptionsColumns[6], UserSubscriptionsColumns[5]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[24], UserSubscriptionsColumns[23]},
			},
			{
