...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "Dsx2API"),
...
func (s *SettingService) UpdateSettings(ctx context.Context, settings *SystemSettings) error {
	...
	updates[SettingKeyFallbackModelZAI] = settings.FallbackModelZAI
	updates[SettingKeyFallbackModelKimi] = settings.FallbackModelKimi
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyFallbackModelZAI:         "glm-4",
		SettingKeyFallbackModelKimi:        "k2p5",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result.FallbackModelZAI = s.getStringOrDefault(settings, SettingKeyFallbackModelZAI, "glm-4")
	result.FallbackModelKimi = s.getStringOrDefault(settings, SettingKeyFallbackModelKimi, "k2p5")
...
func (s *SettingService) GetFallbackModel(ctx context.Context, platform string) string {
	...
	case PlatformAntigravity:
		...
		defaultModel = "gemini-2.5-pro"
	case PlatformZAI:
		key = SettingKeyFallbackModelZAI
		defaultModel = "glm-4"
	case PlatformKimi:
		key = SettingKeyFallbackModelKimi
		defaultModel = "k2p5"
	case PlatformMiniMaxCode:
		key = "fallback_model_minimax"
