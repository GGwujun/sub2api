...
var (
	...
	ErrTokenQuotaExceeded         = infraerrors.TooManyRequests("TOKEN_QUOTA_EXCEEDED", "token quota exceeded")
	ErrTokenQuotaDailyExceeded    = infraerrors.TooManyRequests("TOKEN_QUOTA_DAILY_EXCEEDED", "daily token quota exceeded")
	ErrTokenQuotaWeeklyExceeded   = infraerrors.TooManyRequests("TOKEN_QUOTA_WEEKLY_EXCEEDED", "weekly token quota exceeded")
	ErrTokenQuotaMonthlyExceeded  = infraerrors.TooManyRequests("TOKEN_QUOTA_MONTHLY_EXCEEDED", "monthly token quota exceeded")
