...
// DefaultSoraModels returns the default list of Sora models
func DefaultSoraModels(extra []string) []map[string]any {
	models := []map[string]any{
		{"id": "sora-1.0-turbo", "object": "model", "owned_by": "sora"},
		{"id": "sora-2.0", "object": "model", "owned_by": "sora"},
	}
	for _, m := range extra {
