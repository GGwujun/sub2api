...
func (s *apiKeyRepoStub) IncrementTokenQuotaUsed(ctx context.Context, id int64, tokens int64) (int64, error) {
	panic("unexpected IncrementTokenQuotaUsed call")
}
func (s *apiKeyRepoStub) IncrementTokenQuotaWindows(ctx context.Context, id int64, tokens int64) error {
