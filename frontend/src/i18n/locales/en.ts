export default {
  ...
  home: {
    ...
    homeNew: {
      hero: {
        chip: 'Focus on AI API · Multi-model Stable Relay',
        title1: 'Let teams access',
        title2: 'AI API',
        subtitle: 'No VPN needed, no official account, no foreign credit card/phone number.',
        cta: 'Sign Up Free, Try Now'
      },
      terminal: {
      ...
      features: {
        ...
        sectionHeading: 'Why developers',
        sectionHighlight: 'choose us',
        noProxy: {
          title: 'No VPN Needed',
          description: 'Direct connection, no VPN required, works out of the box.',
          tag1: 'Direct Connection',
          tag2: 'No VPN'
        },
        speed: {
          title: 'Extreme Speed',
          description: 'High-quality links, fast response, elastic bandwidth, smooth even at peak.',
          tag1: 'Low Latency',
          tag2: 'High Bandwidth'
        },
        stable: {
          title: 'Rock Solid',
          description: 'Multi-region backup, auto-switch, high SLA, stable all year.',
          tag1: 'High SLA',
          tag2: 'Multi-region Backup'
        },
        security: {
          title: 'Data Security',
          description: 'HTTPS encrypted transmission. No data interception or analysis. Key data encrypted.',
          tag1: 'HTTPS Encrypted',
          tag2: 'Data Secure'
        }
      },
      pricing: {
        ...
        basic: {
          ...
          period: '/month',
          badge: 'Recommended',
          description: 'For individual developers, supports mainstream models.',
          limit1Label: 'Experience:',
          limit1Value: 'Light daily usage',
          limit2Label: 'Monthly limit:',
          limit2Value: 'Flexible quota',
          feature1: 'Multi-model available',
          feature2: 'Shared channel'
        },
        pro: {
          name: 'Pro',
          price: '$45',
          period: '/month',
          badge: 'Premium',
          description: 'For teams, more models and higher quotas.',
          limit1Label: 'Experience:',
          limit1Value: 'Heavy usage',
          limit2Label: 'Monthly limit:',
          limit2Value: 'Large quota',
          feature1: 'All models available',
          feature2: 'Dedicated high-speed channel'
        }
      },
      steps: {
        sectionTitle: 'Quick Start',
        sectionHeading: 'Three Steps to Start',
        sectionSubtitle: 'No technical knowledge needed',
        stepLabel: 'Step',
        register: {
          title: 'Register Account',
          description: 'Visit homepage, enter email and password to register, done in 1 minute.',
          point1: 'No credit card, free signup',
          point2: 'Email login supported'
        },
        apikey: {
          title: 'Get API Key',
          description: 'Login to dashboard, click new in API Keys page, create key in seconds.',
          point1: 'Create instantly',
          point2: 'Multiple keys for projects',
          point3: 'Disable or delete anytime'
        },
        start: {
          title: 'Start Calling',
          description: 'Set environment variables, connect to AI models instantly.',
          point1: 'Mac / Windows / Linux',
          point2: 'Set once, use long-term'
        },
        registerDemo: {
          emailLabel: 'Email',
        ...
        terminalDemo: {
          ...
          ready: '◆ API Gateway · Ready',
          connected: '✓ Connected to relay node',
          prompt: 'Help me refactor this module...'
        }
      },
      stats: {
        sectionTitle: 'Core Advantages',
        sectionHeading: 'Data Speaks',
        sectionSubtitle: 'Focused on AI API relay, every metric matters',
        stability: {
          title: 'Stability Rate',
          description: 'Optimized relay links, 7×24 monitoring, low latency, no drops.',
          tag1: 'Multi-node redundancy',
          tag2: 'Auto failover'
        },
        latency: {
          title: 'Average Latency',
          description: 'Optimized links, direct requests, fast response. Focus on coding.',
          tag1: 'Optimized',
          tag2: 'Low latency'
        },
        onboard: {
          title: 'Onboarding Time',
          description: 'Two environment variables, tutorials provided, easy for non-tech users.',
          tag1: 'Tutorials',
          tag2: 'One-click config'
        }
      },
      cta: {
        ready: 'Ready?',
        title: 'Start accessing multiple AI models now',
        subtitle: 'Sign up and configure, start using immediately.',
        button: 'Sign Up Free'
      }
    }
  },
  ...
  keys: {
    ...
    tokenQuotaAmountPlaceholder: 'Enter token count (0=unlimited)',
    tokenQuotaAmountHint: 'Limit API key by token usage, takes priority over cost quota',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        tokenQuota: 'Token (Quota)',
        tokenQuotaLimit: 'Total Token Quota',
        tokenQuotaHint: 'Total token quota limit for each API key in this group (no time limit)',
        tokenQuotaDaily: 'Daily Token Quota',
        tokenQuotaWeekly: 'Weekly Token Quota',
  ...
  userSubscriptions: {
    ...
    weekly: 'Weekly',
    monthly: 'Monthly',
    tokenTotal: 'Total Token Quota',
    tokenDaily: 'Daily Token Quota',
    tokenWeekly: 'Weekly Token Quota',
    tokenMonthly: 'Monthly Token Quota',
