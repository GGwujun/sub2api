export default {
  ...
  home: {
    ...
    homeNew: {
      hero: {
        chip: '专注 AI API · 多模型稳定中转服务',
        title1: '让团队更顺畅地接入',
        title2: 'AI API',
        subtitle: '无需魔法，无需官方账号，无需国外信用卡/手机号。',
        cta: '免费注册，立即体验'
      },
      terminal: {
        routing: '路由到上游...',
      ...
      features: {
        sectionTitle: '核心优势',
        sectionHeading: '为什么开发者',
        sectionHighlight: '选择我们',
        noProxy: {
          title: '告别梯子',
          description: '国内直连，无需 VPN，开箱即用，一键配置。',
          tag1: '国内直连',
          tag2: '无需 VPN'
        },
        speed: {
          title: '极致速度',
          description: '高质量链路，响应快速，带宽弹性扩容，高峰依然流畅。',
          tag1: '低延迟',
          tag2: '高带宽'
        },
        stable: {
          title: '稳定如磐',
          description: '多地互备，自动切换，SLA 高，全年稳定运行。',
          tag1: 'SLA 高',
          tag2: '多地互备'
        },
        security: {
          title: '数据安全',
          description: '传输采用 HTTPS 加密。不截留、不分析用户数据。关键数据加密存储。',
          tag1: 'HTTPS 加密',
          tag2: '数据安全'
        }
      },
      pricing: {
        ...
        basic: {
          ...
          period: '/月',
          badge: '推荐',
          description: '适合个人开发者，支持主流模型稳定调用。',
          limit1Label: '使用体验：',
          limit1Value: '日常轻度使用',
          limit2Label: '每月限制：',
          limit2Value: '灵活配额',
        ...
        pro: {
          ...
          period: '/月',
          badge: '顶级',
          description: '适合团队使用，支持更多模型和更高配额。',
          limit1Label: '使用体验：',
          limit1Value: '高强度使用',
          limit2Label: '每月限制：',
          limit2Value: '大额配额',
      ...
      steps: {
        sectionTitle: '快速上手',
        sectionHeading: '三步开始使用',
        sectionSubtitle: '不需要懂技术，按步骤做就行',
        stepLabel: '步骤',
        register: {
          title: '注册账号',
          description: '访问首页，填写邮箱和密码即可完成注册，全程不超过 1 分钟。',
          point1: '无需信用卡，免费注册',
          point2: '支持邮箱一键登录'
        },
        apikey: {
          ...
          point1: '一键创建，即刻生效',
          point2: '可创建多个 Key 分项目',
          point3: '随时禁用或删除'
        },
        start: {
          title: '启动调用',
          description: '设置环境变量，即刻连接到 AI 模型，开始你的开发之旅。',
          point1: '支持 Mac / Windows / Linux',
          point2: '配置一次，长期可用'
        },
        registerDemo: {
          emailLabel: '邮箱',
      ...
      stats: {
        sectionTitle: '核心优势',
        sectionHeading: '数据说话',
        sectionSubtitle: '专注 AI API 中转，每一项指标都认真对待',
        stability: {
          title: '稳定在线率',
          description: '优化的中转线路，7×24 小时监控，低延迟、不掉线，告别连接焦虑。',
          tag1: '多节点冗余',
          tag2: '自动故障切换'
        },
        latency: {
          title: '平均响应延迟',
          description: '优化线路，请求直达，响应快速。你专注写代码，网络延迟的事交给我们。',
          tag1: '国内优化',
          tag2: '低延迟线路'
        },
        onboard: {
          title: '新手上手时间',
          description: '两个环境变量搞定一切，提供图文教程，完全不懂技术也能轻松完成。',
          tag1: '图文教程',
          tag2: '一键配置'
        }
      },
      cta: {
        ready: '准备好了吗',
        title: '现在就开始接入多个 AI 模型',
        subtitle: '注册账号并配置好环境变量，就能直接开始使用。',
        button: '免费注册'
      }
    }
  },
  ...
  keys: {
    ...
    tokens: 'Token',
    tokenQuota: 'Token 额度',
    tokenQuotaAmountPlaceholder: '输入 Token 数量 (0=不限)',
    tokenQuotaAmountHint: '按 Token 使用量限制 API 密钥，优先级高于费用额度',
    today: '今日',
    total: '近30天',
    quota: '额度',
    lastUsedAt: '上次使用时间',
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        subscription: '订阅（配额）',
        tokenQuota: 'Token（配额）',
        tokenQuotaLimit: '总 Token 配额',
        tokenQuotaHint: '该分组下每个 API Key 的总 Token 配额上限（不限时间）',
        tokenQuotaDaily: '每日 Token 额度',
        tokenQuotaWeekly: '每周 Token 额度',
        tokenQuotaMonthly: '每月 Token 额度',
        dailyLimit: '每日限额（USD）',
  ...
  subscriptionProgress: {
    ...
    weekly: '每周',
    monthly: '每月',
    tokenTotal: '总 Token 额度',
    tokenDaily: '每日 Token 额度',
    tokenWeekly: '每周 Token 额度',
    tokenMonthly: '每月 Token 额度',
  ...
  userSubscriptions: {
    ...
    tokenTotal: '总额度',
    tokenDaily: '每日 Token',
    tokenWeekly: '每周 Token',
    tokenMonthly: '每月 Token',
    daysRemaining: '剩余 {days} 天',
    expiresOn: '{date} 到期',
    resetIn: '{time} 后重置',
